...
/*
  ...
  This version has been modified for the jsix libc.
*/
...
namespace __j6libc {
    void * increase_core(intptr_t);
}
#define MORECORE __j6libc::increase_core
...
#if defined __cplusplus && (__GNUC__ >= 3 || __GNUC_MINOR__ >= 8) && !defined(__CYGWIN__) && !defined(__jsix__)
